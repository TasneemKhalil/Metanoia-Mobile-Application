    ...
    <View style={styles.container}>
      <SafeAreaView style={styles.contentContainer}>
        ...
        <View style={{alignSelf:'center', marginTop:50, marginBottom:15,  width:'100%', flexDirection:'row'}}>
          ...
          <TouchableOpacity onPress={()=>{setShowTitle(false)}}>

            {showtitle && <Text style={{color:'white', fontSize:25, marginStart:5}}>{item.title}</Text>}
            {!showtitle && 
              // <Text style={{color:'white', fontSize:25, marginStart:5}}>magic here</Text>
          ...
          <ScrollView style={{ margin:10}}>
              ...
              <View style={{marginVertical:10, marginHorizontal:20, flexDirection:'row'}}>
                <TouchableOpacity style={{flexDirection:'row'}} onPress={() => setRevealedTime(prevState => !prevState)}>
                  ...
                  {( selectedDate != null && selectedDate != '' ) && <Text style={{alignSelf:'center', marginStart:5, fontSize:18, fontWeight:'500'}}>Due to :{selectedDate}</Text>}
              ...
              {revealedAlarm && 
               ...
               {/* /////set subject///////////////////////////////////////////////////// */}
               <View style={{marginBottom:10, marginHorizontal:20, flexDirection:'row'}}>
                <TouchableOpacity style={{flexDirection:'row'}} onPress={() => setRevealedSubject(prevState => !prevState)}>
              ...
              <View style={{ marginTop:20, marginBottom:5, alignSelf:'center', width:'85%', justifyContent:'space-between', flexDirection:'row'}}> 
                ...
                {!edit && <AntDesign name="edit" size={26} color="#444" style={{marginTop:2}} onPress={()=>{setEdit(true), setShowSave(true)}}/>}
                {edit && <AntDesign name="closesquareo" size={26} color="black" onPress={()=>{setEdit(false), setShowSave(false)}}/>}
              </View>
